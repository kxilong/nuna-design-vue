  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return _ctx.src || ((_a = _ctx.$slots) == null ? void 0 : _a.icon) ? (openBlock(), createElementBlock("span", {
        ...
        }, null, 8, _hoisted_1)) : ((_b = _ctx.$slots) == null ? void 0 : _b.icon) ? (openBlock(), createElementBlock("span", _hoisted_2, [
...
var Avatar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4d8f0c06"]]);
...
export { NAvatar, NAvatar as default };
